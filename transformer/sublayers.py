...
class ScaledDotProductAttention(nn.Module):
    ...
    def forward(self, query: Tensor, key: Tensor, value: Tensor, mask: Tensor=None):
        ...
        filtered_value = torch.matmul(attention_filter, value)
        return filtered_value, attention_filter
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, query: Tensor, key: Tensor, value: Tensor, mask: Tensor=None):
        ...
        # we separate the attention heads
        # shape of query, key, value: (n_batches, d_model, d_model) -> (n_batches, d_model, heads, d_k)
        # shape of query, key, value: -> (n_batches, d_model, heads, d_k) -> (n_batches, heads, d_model, d_k)
